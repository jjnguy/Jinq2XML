...
public class JodeList implements Iterable<Jode> {
        ...
        return new Iterator<Jode>() {
            ...
            public void remove() {
                throw new UnsupportedOperationException(
                        "You are not allowed to remove jodes fron a list");
            }
        };
    }
    ...
    /**
     * Will return the only element of this list with the given node name. If there is more than one
     * matching element, this will throw an {@link JinqException}.
     * 
     * @param nodeName
    ...
    /**
     * Will give you to single element of this list matching a given name. If there is more than one
     * matching element, this will throw an {@link JinqException}.
     * 
     * @param filter
    ...
    /**
     * Will attempt to parse this list of nodes into the passed in type. See jode.toObject for more
     * info.
     * 
     * @param <T>
