...
public class Jode {
    ...
    /**
     * This parses this xml node (and children) into an instance of the given class. In order for
     * this to work, the given type and all types of it's member variables must have a no argument
     * constructor. All types must also only have fields that are primitaves, strings, or
     * (array)lists. I'm sure there are other assumptions I made that I'm leaving out.
     * 
     * @param <T>
